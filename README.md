...
This package provides **YoBit exchange adapter for bt_api** for the [bt_api](https://github.com/cloudQuant/bt_api_py) framework. It offers a unified interface for interacting with **YOBIT** exchange.
...
| Resource | Link |
|----------|------|
| English Docs | https://bt-api-yobit.readthedocs.io/ |
...
- Report bugs via [GitHub Issues](https://github.com/cloudQuant/bt_api_yobit/issues)
...
本包为 [bt_api](https://github.com/cloudQuant/bt_api_py) 框架提供 **YoBit exchange adapter for bt_api**。它提供了与 **YOBIT** 交易所交互的统一接口。
...
| 资源 | 链接 |
|------|------|
| 英文文档 | https://bt-api-yobit.readthedocs.io/ |
...
- 通过 [GitHub Issues](https://github.com/cloudQuant/bt_api_yobit/issues) 反馈问题
